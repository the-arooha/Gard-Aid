package com.example.loginactivity.categories.perennial
...
class PerennialActivity : AppCompatActivity(), UsersAdapter.ClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_perennial)
        initData();
    }
    ...
    private  fun populateUsers():List<UserModel>{
        ...
        userList.add(UserModel("Bougainvillea"))
        userList.add(UserModel("Hibiscus Rosa Sinensis"))
        userList.add(UserModel("Ixora"))
        userList.add(UserModel("Lantana"))
        userList.add(UserModel("Adenium"))
        userList.add(UserModel("Milii"))
        userList.add(UserModel("Kalanchoe"))
        userList.add(UserModel("Crossandra"))
        userList.add(UserModel("Tiobouchina"))
        userList.add(UserModel("Mussaenda acuminta"))
        userList.add(UserModel("Crape Jasmine"))
        userList.add(UserModel("Allamanda cathartica"))
        return userList;
    }
