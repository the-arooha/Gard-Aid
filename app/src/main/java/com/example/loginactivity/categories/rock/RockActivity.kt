package com.example.loginactivity.categories.rock
...
class RockActivity : AppCompatActivity(), UsersAdapter.ClickListener {
    ...
    private  fun populateUsers():List<UserModel>{
        ...
        userList.add(UserModel("Create a Rock Garden"))
        return userList
    }
...
//    }
    ...
    override fun clickedItem(userModel: UserModel) {
        when (userModel.username) {
            "Create a Rock Garden" -> startActivity(Intent(this, Rock1Activity::class.java))
