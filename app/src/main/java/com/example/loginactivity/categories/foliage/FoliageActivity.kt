package com.example.loginactivity.categories.foliage
...
class FoliageActivity : AppCompatActivity(), UsersAdapter.ClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_foliage)
        initData();
    }
    ...
    private  fun populateUsers():List<UserModel>{
        ...
        userList.add(UserModel("Coleus"))
        userList.add(UserModel("Begonias"))
        userList.add(UserModel("Euphorbia"))
        userList.add(UserModel("Artemisia"))
        userList.add(UserModel("Ornamental Grasses"))
        return userList;
    }
    ...
    override fun clickedItem(userModel: UserModel) {
        when (userModel.username) {
            "Coleus" -> startActivity(Intent(this, ColeusActivity::class.java))
