package com.example.loginactivity.categories.butterfly
...
class ButterflyActivity : AppCompatActivity(), UsersAdapter.ClickListener {
    ...
    private  fun populateUsers():List<UserModel>{
        ...
        userList.add(UserModel("Grow Butterfly Garden"))
        return userList
    }
...
//    }
    ...
    override fun clickedItem(userModel: UserModel) {
        when (userModel.username) {
            "Grow Butterfly Garden" -> startActivity(Intent(this, Butterfly1Activity::class.java))
